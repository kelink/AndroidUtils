...
package com.app.common.fancycoverflow;
...
/**
 * coverflow是一个用于切换音频专辑、视频封面等画廊控件，它是苹果的专利，目前也被广泛用于android系统中，其中fancycoverflow是一个android开源项目
 * 项目地址：<a href="https://github.com/zmywly8866/FancyCoverFlow" target="_blank">FancyCoverFlow</a>，使用步骤如下：
 * 1、在xml中做如类似如下定义：
 * <com.eebbk.bbk.pen.common.fancycoverflow
        android:id="@+id/fancyCoverFlow"
        android:layout_width="match_parent"
        android:layout_height="match_parent"
        />
   
   2、自定义Adapter，继承FancyCoverFlowAdapter；
   3、初始化FancyCoverFlow。
